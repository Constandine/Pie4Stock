	...
	*/
	...
	function Move(){ 
		...
		if($firstBG.hasClass("inview")){
			...
			bg1.css({'backgroundPosition': newPos(50, windowHeight, pos, 1140, 0.1)});
			bg2.css({'backgroundPosition': newPos(50, windowHeight, pos, 3700, 0.2)});
			bg3.css({'backgroundPosition': newPos(50, windowHeight, pos, 750, 0.05)});
			bg5.css({'backgroundPosition': newPos(50, windowHeight, pos, 5450, 0.15)});
		}
